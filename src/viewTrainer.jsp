...
<body>
		...
		for (Trainer trainer: trainers) {
		    ...
		    <td><%= trainer.getExperience() %></td>
                    <td>
                        <a href=EmployeeController?action=updateTrainer&trainerId=<%=employee.getEmployeeId()%> ><input type="button" value="update"></a>
                    </td>
                    <td>
                        <a href=EmployeeController?action=deleteTrainer&trainerId=<%=employee.getEmployeeId()%>  ><input type="button" value="delete"></a>
                    </td>
		</tr>
		<%}%>
		</table>
