...
import com.ideas2it.employee.service.interf.TraineeServiceInterf;
...
@Service
public class TraineeServiceImpl extends TraineeServiceInterf {
    ...
    public List<Integer> validateAndAddTraineeDetails(Trainee trainee) {
        ...
        if (DateUtil.computePeriod(trainee.getDateOfBirth(), LocalDate.now()) < 18 && trainee.getDateOfBirth() != LocalDate.now()) {
            invalidOption.add(2);
        }
