...
<body>
		...
		<tr>
		    ...
		    <td><%= trainerIds.toString().replaceAll("[\\[\\]]","") %></td>
                    <td>
                        <a href=EmployeeController?action=updateTrainee&traineeId=<%=employee.getEmployeeId()%> ><input type="button" value="update"></a>
                    </td>
                    <td>
                        <a href=EmployeeController?action=deleteTrainee&traineeId=<%=employee.getEmployeeId()%>  ><input type="button" value="delete"></a>
                    </td>
		</tr>
		<%}%>
		</table>
