...
public interface TraineeService_Interf {
    ...
    void modifyTraineeDetails(Trainee updateTrainee, int updateChoice);
    void removeTraineeDetails(int traineeId);
    List<Integer> validateAndAddTraineeDetails(Trainee tempTrainee);
    boolean validateTraineePhoneNumber(long phoneNumber,Trainee trainee, int updateChoice);
    boolean validateTraineeEmailId(String emailId, Trainee trainee, int updateChoice);
    boolean validateTraineeAadharId(long aadhar,Trainee trainee, int updateChoice);
